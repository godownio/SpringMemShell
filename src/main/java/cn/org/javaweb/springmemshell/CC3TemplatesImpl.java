...
//        byte[] code1 = Files.readAllBytes(Paths.get("target/classes/cn/org/javaweb/springmemshell/Generic/SpringGenericMemShell.class"));
//        byte[] code1 = Files.readAllBytes(Paths.get("target/classes/cn/org/javaweb/springmemshell/Controller/ControllerMemShell.class"));
        byte[] code1 = Files.readAllBytes(Paths.get("target/classes/cn/org/javaweb/springmemshell/Interceptor/InterceptorMemShell.class"));
